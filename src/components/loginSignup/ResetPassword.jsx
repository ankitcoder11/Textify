...
import { InputPasswordComponent } from '../../utiles/InputLoginComponent';
...
const ResetPassword = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col items-center justify-center gap-[15px] w-1/2 h-full'>
            ...
            <Button text="Reset Password" onClick={handleSubmit} isLoading={loading} className='w-full' />
        </form>
    );
};
